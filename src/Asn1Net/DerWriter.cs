...
namespace Net.Asn1
{
    ...
    public class DerWriter
    {
        ...
        public DerWriter Write(Asn1ObjectBase objectToWrite)
        {
            ...
            if (objectToWrite is Asn1Eoc)
            {
                throw new InvalidDataException(FormattableString.Invariant($"{nameof(Asn1Eoc)} is not allowed in DER."));
            }
