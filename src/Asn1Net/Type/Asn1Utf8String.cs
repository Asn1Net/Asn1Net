...
namespace Net.Asn1.Type
{
    ...
    public class Asn1Utf8String : Asn1Object<string>
    {
        ...
        /// Preferably used when encoding UTF8 STRING.
        /// </summary>
        ...
        internal Asn1Utf8String(SubStream content)
            : base(Asn1Class.Universal, false, (int)Asn1Type.Utf8String, content)
        {
        }
        ...
        /// <summary>
        /// Read the value of the given node as Utf8 string.
        /// </summary>
        /// <returns>Value of the given node as Utf8 string.</returns>
