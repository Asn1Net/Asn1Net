...
namespace Net.Asn1.Type
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Asn1GeneralString"/> class. Preferably used when encoding GENERALIZED STRING.
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Asn1GeneralString"/> class. Preferably used when reading GENERALIZED STRING.
        /// </summary>
        ...
        internal Asn1GeneralString(SubStream content, bool constructed)
            : base(Asn1Class.Universal, constructed, (int)Asn1Type.GeneralString, content)
        {
        }
        ...
        /// </summary>
        /// <returns>>Value of the given node as General string.</returns>
