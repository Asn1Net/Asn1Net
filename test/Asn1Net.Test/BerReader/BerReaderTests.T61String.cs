...
namespace Net.Asn1.Writer.Tests
{
    public partial class BerReaderTests
    {
        ...
        [Theory]
        public void ReadT61String(string valueToTest, string correctResult)
        {
            ...
            using (var ms = new MemoryStream(encoded))
            {
                ...
                var asn1T61String = asn1Obj.First() as Asn1T61String;
                Assert.NotNull(asn1T61String);

                Assert.True(asn1T61String.Content == correctResult);
            }
        }
    }
}
